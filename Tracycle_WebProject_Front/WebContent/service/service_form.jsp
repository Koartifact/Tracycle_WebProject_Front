	...
	<div id="blog" class="site-header-section">
		<div class="container">
			...
			<div class="form-group">
				<label for="content" class="label-font-bold">지역 </label><br> <select
					class="selectpicker" name="selectedArea" v-model="area.areaId">
			...
			<div class="form-group">
				...
				<input type="file" name="file" accept="image/*" id="file_upload"
					ref="mainFile" v-on:change="mainFileUpload()" /> <input
					type="button" v-on:click="submit()" value="upload" id="upload" />
			</div>

			<!-- 이미지 컴포넌트 추가 -->
			<div id="viewer">
				<img id="img" v-if="image != ''" :src="image"
								...
								<div class="media-body p-3 mt-3">
									<a href="../board/board_form.jsp"> <span
										style="color: rgba(128, 156, 168, 1)"><i
											...
											style="width: 100px; height: 150px;"></i></span>
										<h6 class="heading mb-4" style="color: black">작은 실천이 큰 힘이
											됩니다</h6>
